  ...
  return (
    ...
    <main className="min-h-screen bg-black text-white selection:bg-[#Ff3131] selection:text-white">
      ...
      <section className="relative w-full pt-40 pb-20 px-6 overflow-hidden">
        {/* Background Grid - Warm tint added to grid */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] pointer-events-none"></div>
        
        {/* Subtle top glow matching the start color */}
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <span className="inline-block py-1 px-3 rounded-full bg-[#Ff3131]/10 border border-[#Ff3131]/20 text-[#Ff3131] text-sm font-mono font-bold mb-6 tracking-wider">
      ...
      <section className="py-20 px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-[#Ff3131] to-[#ff914d] rounded-full"></div>
          </div>
      ...
      <section className="py-20 bg-neutral-900/30 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6 text-center">
           <h2 className="text-3xl md:text-4xl font-bold mb-16">
             Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#Ff3131] to-[#ff914d]">Tech Stack</span>
           </h2>
      ...
      <section className="py-32 px-6 relative overflow-hidden">
        {/* Skewed background in Start Color tint */}
        <div className="absolute inset-0 bg-[#Ff3131]/5 skew-y-3 transform origin-bottom-right pointer-events-none"></div>
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            {/* Gradient Button */}
            <Link href="/contact" className="px-8 py-4 rounded-full bg-gradient-to-r from-[#Ff3131] to-[#ff914d] text-white font-bold text-lg hover:shadow-[0_0_25px_rgba(255,49,49,0.4)] transition-all transform hover:-translate-y-1">
              Start Your Project
            </Link>
...
function ServiceCard({ title, description, icon }: { title: string, description: string, icon: React.ReactNode }) {
  return (
    <motion.div 
      whileHover={{ y: -5 }}
      // Hover Border using Start Color
      className="p-8 rounded-2xl bg-neutral-900/50 border border-white/10 hover:border-[#Ff3131]/50 hover:bg-neutral-900 transition-all duration-300 group"
    >
      {/* Icon Container with Hover Glow */}
      <div className="mb-6 p-3 bg-black rounded-lg w-fit border border-white/10 group-hover:border-[#Ff3131]/30 group-hover:shadow-[0_0_15px_rgba(255,49,49,0.2)] transition-all">
        {icon}
      </div>
      {/* Title Hover Color -> End Color */}
      <h3 className="text-xl font-bold text-white mb-3 group-hover:text-[#ff914d] transition-colors">{title}</h3>
...
function TechBadge({ name }: { name: string }) {
  return (
    <div className="flex items-center justify-center p-4 border border-white/5 rounded-xl bg-neutral-950 hover:border-[#Ff3131]/30 hover:text-[#ff914d] transition-colors cursor-default">
